...
namespace Asteroids
{
    public class WaspFactory : IEnemyFactory
    {
        ...
        public Enemy Create()
        {
            ...
            ShipShoting shipShoting = new ShipShoting(_waspSettings.ShotSettings.Bullet, barrel.transform, _waspSettings.ShotSettings.Force, _poolServices, AttackType.Damage, _waspSettings.ShotSettings.Damage);
